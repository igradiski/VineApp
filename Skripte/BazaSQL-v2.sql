...
CREATE TABLE IF NOT EXISTS `vineappdb`.`spricanje_has_zastitno_sredstvo` (
  `Spricanje_id` INT(11) NOT NULL,
  `zastitno_sredstvo_id` INT(11) NOT NULL,
  `id` INT(11) NOT NULL AUTO_INCREMENT,
  `dosage` DECIMAL(10,0) NULL DEFAULT NULL,
  `remark` VARCHAR(45) NOT NULL,
  `user_dosage` INT(11) NOT NULL,
  PRIMARY KEY (`id`),
  INDEX `fk_Spricanje_has_zastitno_sredstvo_zastitno_sredstvo1_idx` (`zastitno_sredstvo_id` ASC) ,
  INDEX `fk_Spricanje_has_zastitno_sredstvo_zastitno_sredstvo12` (`Spricanje_id` ASC) ,
  CONSTRAINT `fk_Spricanje_has_zastitno_sredstvo_zastitno_sredstvo1`
    ...
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_Spricanje_has_zastitno_sredstvo_zastitno_sredstvo12`
    FOREIGN KEY (`Spricanje_id`)
    REFERENCES `vineappdb`.`spricanje` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8;
...
CREATE TABLE IF NOT EXISTS `vineappdb`.`vinograd_has_vinovaloza` (
  `Vinograd_ID` INT(11) NOT NULL,
  `VinovaLoza_id` INT(11) NOT NULL,
  `id` INT(11) NOT NULL AUTO_INCREMENT,
