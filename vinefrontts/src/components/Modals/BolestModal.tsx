...
const BolestModal: FunctionComponent<Props> = ({visibleModal,closeModal,bolest}) => {
    ...
    const getBolestData = () =>{
        if(bolest !== ""){
            bolestService.findByName(bolest)
        .then(response =>{
        ...
        >
            <div className="modal-div">
                ...
                <div className="modal-row">
                    ...
                    <p className="p-content">{datumClass.convertDateForTable(datum)}</p>
                </div>
            </div>
