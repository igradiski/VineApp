...
public class SpricanjeSredstvoController {
    ...
    @GetMapping("/sredstvo/{id}")
    @Operation(summary = "Opracija za dohvacanje sredstva u spricanju")
    public Page<SpricanjeSredstvoDto> getSredstvaPaged(Pageable pageable,
    ...
    public ResponseEntity<Object> updateSredstvoById(
        ...
        return spricanjeSredstvoService.updateSredstvoById(spricanjeSredstvoDto);
    }
